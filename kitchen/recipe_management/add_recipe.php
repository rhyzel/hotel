    ...
    if ($recipe_name) {
        try {
            if (!empty($_FILES['image']['name'])) {
                ...
                $clean_name = preg_replace('/[^a-zA-Z0-9_-]/', '_', strtolower($recipe_name));
            ...
            $stmt = $pdo->prepare("INSERT INTO recipes (recipe_name, category, instructions, preparation_time, price, image_path, created_at) VALUES (?, ?, ?, ?, ?, ?, NOW())");
